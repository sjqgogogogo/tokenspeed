...
Status: investigation only. Prompt/top-K diagnostics still reject speculative
execution. This document does not enable MTP, tree verification, or PD serving.
