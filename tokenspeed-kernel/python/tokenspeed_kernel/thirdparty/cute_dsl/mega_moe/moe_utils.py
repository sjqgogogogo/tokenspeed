...
class MoEScaledGroupedGemmTensormapConstructor(OnlineTensormapDescCreator):
    ...
    def _construct_c_desc_2dx3d(self, expert_idx: Int32) -> None:
        ...
        c_i = rewrite_tensor_shape(
            c_i, (tokens_i, self.c_tensor.shape[1], c1)
        )  # type: ignore[index]
    ...
    def _construct_ab_descs_2dx2d(self, expert_idx: Int32) -> None:
        ...
        a_i = rewrite_tensor_shape(
            a_i, (self.a_tensor.shape[0], tokens_i, c1)
        )  # type: ignore[index]
        ...
        b_i = rewrite_tensor_shape(
            b_i, (self.b_tensor.shape[0], tokens_i, c1)
        )  # type: ignore[index]
    ...
    def _construct_sf_descs_2dx2d_direct(
        ...
        per_expert_sfa_shape = (
            self.sfa_tensor.shape[0],
            padded_size_i,
            c1,
        )  # type: ignore[index]
        ...
        per_expert_sfb_shape = (
            self.sfb_tensor.shape[0],
            padded_size_i,
            c1,
        )  # type: ignore[index]
